...
func NewMainKubelet(kubeCfg *kubeletconfiginternal.KubeletConfiguration,
	...
	// DynamicPluginProber = flexVolume  kubeDeps app/server.go 调用kubelet/app/plugin.go.GetDynamicPluginProber
	// VolumePlugins = kubeDeps app/server.go 调用kubelet/app/plugin.go.ProbeVolumePlugins
...
func (kl *Kubelet) syncPod(o syncPodOptions) error {
	...
	// 检查pod是否可以运行 如果不能运行则需要更新对应状态及为何不能运行的原因
	...
	// pod不能运行、pod处于被删除状态、pod处于失败状态 则kill pod
...
//                     containers have failed liveness checksls
